...
constexpr int kMotorEnRight  = 15;  // ENB (PWM) — right motor speed
constexpr int kMotorIn3      = 16;  // IN3 — right motor direction A
constexpr int kMotorIn4      = 47;  // IN4 — right motor direction B
...
constexpr int kDispSclk   = 12;  // shared SCL/SCLK
constexpr int kDispCsLeft  = 10;
constexpr int kDispCsRight = 13;
...
constexpr int kVbatSense = 4;  // ADC1_CH3

// Spare, safe-to-use: GPIO 39, 40, 48.
